...
if [[ ${PV} == 9999 ]]; then
	...
	COMMIT="4621b88ee2e0f2cdbcb76d9f14eda4922c0123f4"
...
VIDEO_CARDS="${RADEON_CARDS} d3d12 freedreno intel lima nouveau tegra panfrost v3d vc4 virgl vivante vmware"
...
RDEPEND="
	...
	${LIBDRM_DEPSTRING}[video_cards_freedreno?,video_cards_intel?,video_cards_nouveau?,video_cards_tegra?,video_cards_vc4?,video_cards_vivante?,video_cards_vmware?,${MULTILIB_USEDEP}]
	X? (
