...
if [[ ${PV} == 9999 ]]; then
	...
	COMMIT="92ba621cb1aa8e7ad28454801e9a05db60dcf0ea"
...
VIDEO_CARDS="${RADEON_CARDS} freedreno i915 i965 intel iris lima nouveau tegra panfrost v3d vc4 virgl vivante vmware"
